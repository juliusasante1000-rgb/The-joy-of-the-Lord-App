...
export function generateBibleVerseDocumentHTML(
  ...
  const syntheticDevotion: Devotion = {
    ...
    practicalApplication: item.reflection || `Meditate on ${bookRef} today, allowing the Holy Spirit to transform your mind and align your daily decisions with God's living truth.`,
...
export function generateSystematicTopicDocumentHTML(
  ...
  const syntheticDevotion: Devotion = {
    ...
    practicalApplication: topic.practicalApplication || `Live out the biblical doctrine of "${topic.title}" with personal conviction, steady prayer, and humble obedience to Christ.`,
