...
/**
 * Rich Reservoir of Canonical Bible Chapter Summaries
 * Strictly adheres to:
 * - At least 2 specific events, names, or parables per chapter.
 * - Simple English, clear narrative focus.
 * - Signed off with "- Bismark Twum".
 */
export const ADDITIONAL_CHAPTER_RESERVOIR: Record<string, ChapterSummary> = {
  // ==================== MATTHEW ====================
  "Matthew_1": {
    book: "Matthew",
    chapter: 1,
    summary:
      "Matthew begins with the royal genealogy of Jesus Christ from Abraham through King David to Joseph, fulfilling the Messianic covenant line. Mary is found to be with child through the Holy Spirit before she and Joseph marry. An angel of the Lord appears to Joseph in a dream, telling him not to fear taking Mary as his wife because the child conceived in her is from the Holy Spirit. Joseph obeys the angel, takes Mary into his home, and names the baby Jesus, fulfilling Isaiah's prophecy of Immanuel, God with us.\n\n— Bismark Twum",
    key_verses: ["Matthew 1:1", "Matthew 1:21", "Matthew 1:23"],
    theme: "The Genealogy and Birth of Jesus Christ",
    lesson: "God faithfully fulfills His promises through history and saves His people from their sins.",
    questions: [
      "What name did the angel tell Joseph to give the child, and what does it mean?",
      "Which Old Testament prophet's words were fulfilled by Jesus' virgin birth?"
    ]
  },
  "Matthew_2": {
    book: "Matthew",
  ...
  "Matthew_3": {
    ...
    key_verses: ["Matthew 3:2", "Matthew 3:11", "Matthew 3:16-17"],
  ...
  "Matthew_4": {
    ...
    key_verses: ["Matthew 4:4", "Matthew 4:17", "Matthew 4:19"],
  ...
  "Matthew_5": {
    ...
    chapter: 5,
    summary:
      "Jesus goes up on a mountainside and opens the Sermon on the Mount, proclaiming the Beatitudes to describe the blessed character of Kingdom citizens. He declares His followers to be the salt of the earth and the light of the world whose good works glorify their Father in heaven. Jesus emphasizes that He came not to abolish the Law or Prophets but to fulfill them, raising righteousness beyond the legalistic standards of the scribes. He addresses anger as heart murder, lust as adultery of the heart, commands honesty without swearing oaths, and instructs His followers to turn the other cheek and love their enemies.\n\n— Bismark Twum",
    key_verses: ["Matthew 5:14", "Matthew 5:16", "Matthew 5:44"],
    theme: "The Sermon on the Mount: The Beatitudes and Kingdom Morality",
    lesson: "God looks beyond outward religious rituals into the purity, love, and integrity of our hearts.",
    questions: [
      "What two metaphors did Jesus use to describe believers' influence on the earth?",
      "How did Jesus instruct His followers to treat their enemies and persecutors?"
    ]
  },
  "Matthew_6": {
    book: "Matthew",
  ...
  "Matthew_28": {
    ...
    chapter: 28,
    summary:
      "Early on Sunday morning, Mary Magdalene and the other Mary visit the tomb when a violent earthquake occurs as an angel of the Lord rolls back the stone and sits on it, terrifying the Roman guards. The angel tells the women, 'Do not be afraid, for I know that you seek Jesus who was crucified. He is not here, for He has risen, as He said!' As the women run with great joy to tell the disciples, the risen Jesus meets them on the way and says 'Greetings!', allowing them to touch His feet and worship Him. On a mountain in Galilee, Jesus commissions the disciples with the Great Commission: 'All authority in heaven and on earth has been given to Me. Go therefore and make disciples of all nations, baptizing them in the name of the Father and of the Son and of the Holy Spirit.'\n\n— Bismark Twum",
    key_verses: ["Matthew 28:5-6", "Matthew 28:9", "Matthew 28:18-20"],
    theme: "The Resurrection of Jesus and the Great Commission",
    lesson: "Jesus has conquered sin and the grave, holding all authority and walking with us always.",
    questions: [
      "What did the angel announce to the women at the empty tomb?",
      "What promises and commands did Jesus give in the Great Commission?"
    ]
  },
  ...
  "Acts_1": {
    ...
    chapter: 1,
    summary:
      "Before ascending to heaven, the resurrected Jesus spends forty days speaking with the apostles about the Kingdom of God and instructs them to wait in Jerusalem for the promise of the Holy Spirit. He gives the foundational commission: 'You will receive power when the Holy Spirit comes on you; and you will be my witnesses in Jerusalem, and in all Judea and Samaria, and to the ends of the earth.' As they watch, Jesus is taken up in a cloud, and two angels in white announce that He will return in the same way. The apostles return to the Upper Room to pray continually, where Peter leads them to cast lots and appoint Matthias to replace Judas Iscariot.\n\n— Bismark Twum",
    key_verses: ["Acts 1:8", "Acts 1:11", "Acts 1:14"],
    theme: "The Ascension of Jesus and Promise of the Holy Spirit",
    lesson: "Wait upon the Holy Spirit's empowerment to fulfill God's global kingdom mission.",
    questions: [
      "Where did Jesus tell the apostles to wait for the Holy Spirit?",
      "Who was selected to take the place of Judas Iscariot among the twelve?"
    ]
  },
  "Acts_2": {
    book: "Acts",
    chapter: 2,
    summary:
      "On the Day of Pentecost, about 120 believers gather in one place when suddenly a sound like a violent rushing wind fills the house and tongues of fire rest on each of them. Filled with the Holy Spirit, they begin speaking in other languages as the Spirit enables them, astonishing visitors from across the Roman Empire. Peter stands with the eleven and preaches from the prophet Joel and David, declaring that the crucified Jesus is both Lord and Christ whom God raised from the dead. Convicted to the heart, three thousand people repent, are baptized, and unite in steadfast doctrine, fellowship, breaking of bread, and prayers.\n\n— Bismark Twum",
    key_verses: ["Acts 2:4", "Acts 2:38-39", "Acts 2:42"],
    theme: "The Outpouring of the Holy Spirit and Birth of the Church",
    lesson: "The Holy Spirit empowers every believer to witness boldly and live in supernatural community.",
    questions: [
      "What two physical manifestations accompanied the arrival of the Holy Spirit?",
      "How many souls repented and were baptized after Peter's Pentecost sermon?"
    ]
  },
  "Acts_3": {
    book: "Acts",
    ...
    key_verses: ["Acts 3:6", "Acts 3:8", "Acts 3:19"],
  ...
  "Acts_4": {
    ...
    key_verses: ["Acts 4:12", "Acts 4:19-20", "Acts 4:31"],
  ...
  "Romans_8": {
    ...
    chapter: 8,
    summary:
      "Paul declares that there is now no condemnation for those who are in Christ Jesus, because the law of the Spirit of life has set us free from the law of sin and death. Those who are led by the Spirit of God are children of God, receiving the Spirit of adoption by which we cry 'Abba, Father,' and sharing in Christ's glory. Paul writes that the present sufferings are not worthy to be compared with the glory that will be revealed, noting that the Spirit helps our weaknesses with groanings that cannot be uttered. He concludes with the glorious assurance that all things work together for good to those who love God, and nothing in all creation can separate us from the love of God in Christ Jesus.\n\n— Bismark Twum",
    key_verses: ["Romans 8:1", "Romans 8:28", "Romans 8:38-39"],
    theme: "Life in the Spirit and Inseparable Love of God",
    lesson: "No guilt, suffering, or trial can sever the eternal love and victorious purpose of God in your life.",
    questions: [
      "What title of intimacy does the Holy Spirit give us to cry out to God?",
      "According to Romans 8:28, for whom do all things work together for good?"
    ]
  },
  "Romans_12": {
    book: "Romans",
    chapter: 12,
    summary:
      "Paul urges believers by the mercies of God to present their bodies as living sacrifices, holy and acceptable to God, which is their reasonable service of worship. He instructs them not to conform to the pattern of this world, but to be transformed by the renewing of their minds so they can test and discern God's good, pleasing, and perfect will. Paul teaches about spiritual gifts within the body of Christ—prophecy, serving, teaching, encouraging, giving, leadership, and mercy—exhorting each member to exercise them with humility and diligence. He concludes with practical Christian ethics: love without hypocrisy, bless those who persecute you, weep with those who weep, and overcome evil with good.\n\n— Bismark Twum",
    key_verses: ["Romans 12:1-2", "Romans 12:9", "Romans 12:21"],
    theme: "Living Sacrifices, Mind Renewal, and Christian Character",
    lesson: "True worship is demonstrated through transformed thoughts, humble service, and loving conduct.",
    questions: [
      "How are believers transformed according to Romans 12:2?",
      "How does Paul instruct Christians to conquer evil?"
    ]
  }
};
